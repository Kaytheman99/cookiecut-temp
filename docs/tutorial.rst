...
``If your virtualenv folder i Move into this folder, and then setup git to use your GitHub repo and upload the code:
s within your project folder, be sure to add the virtualenv folder name to your .gitignore file.``

You will find one folder named after the ``[project_slug]``.
.. code-block:: bash

    cd mypackage
    git init     .. code-block:: bash
    git add .
